                ...
                <div class="col-lg-12">
                        ...
                        <div class="form-group" style="margin-left: 12px;">
                            ...
                            <div class="form-horizontal">
                                <div id="divStat" class="centered form-group text-center" runat="server">
                                    <div class="col-xs-3 centered text-center">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-3">
                                        ...
                                        <asp:DropDownList ID="ddUnidades" runat="server" class="btn btn-default dropdown-toggle gr col-xs-12" data-toggle="dropdown" DataSourceID="obUnidades" DataTextField="nome" DataValueField="nome"></asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <table border="0" class="centered">
                                                <tr>
                                                    <td width="100%">
                                                        ...
                                                        <asp:ListBox ID="lstLeft" runat="server" SelectionMode="Multiple" CssClass="form-control col-xs-12">
                                                ...
                                                <tr>
                                                    <td width="100%">
                                                        ...
                                                        <asp:ListBox ID="lstRight" runat="server" SelectionMode="Multiple" CssClass="form-control col-xs-12 crit"></asp:ListBox>
                                                    </td>
                                                    <td>
                                        ...
                                        <div class="col-xs-3">
                                            ...
                                            <div class="form-group col-xs-12">
                                                <asp:DropDownList ID="ddRTV" runat="server" class="btn btn-default dropdown-toggle rtv col-xs-12" data-toggle="dropdown" DataSourceID="obRTV" DataTextField="name" DataValueField="name"></asp:DropDownList>
                                        ...
                                        <div class="col-xs-3">
                                            ...
                                            <div class="form-group col-xs-12">
                                                <asp:DropDownList ID="ddSuper" runat="server" class="btn btn-default dropdown-toggle gr col-xs-12" data-toggle="dropdown" DataSourceID="obSR" DataTextField="name" DataValueField="name"></asp:DropDownList>
                                        ...
                                        <div class="col-xs-3">
                                            ...
                                            <div class="form-group col-xs-12">
                                                <asp:DropDownList ID="ddGr" runat="server" class="btn btn-default dropdown-toggle gr col-xs-12" data-toggle="dropdown" DataSourceID="obGR" DataTextField="name" DataValueField="name"></asp:DropDownList>
                        ...
                        <div class="form-group" style="margin-left: 12px;">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12" id="div4" runat="server">
                    ...
                    <div class="form-panel">
                        <div class="form-group" style="margin-left: 12px;">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-xs-12" id="divEspec" runat="server">
                                        <p>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" id="Div3" runat="server">
                                                    ...
                                                    <asp:DropDownList ID="ddContact" runat="server" class="btn btn-default dropdown-toggle gr col-xs-12" data-toggle="dropdown" DataSourceID="obContact" DataTextField="description" DataValueField="id_coop_contact"></asp:DropDownList>
