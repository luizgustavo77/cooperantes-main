...
namespace apoio_monsanto
{
	public class glamom
	{
        ...
        public DataSet login (String login, String pass)
        {
            ...
            query = " SELECT NAME, EMAIL, LOGIN, TYPE, CHANGEPASS, COOPERANTES, VISUALIZA, DISTRITO FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE TYPE in(1,2,3,4,5,6,99) AND LOGIN='" + login + "' AND PASS='" + dbAcess.Encrypt(pass) + "' AND ACTIVE=1";
        ...
        public String customer_add (int type, String name, String doc, String sap, String sap_filial, String regional, String unidade)
        {
            ...
            query = " SELECT COUNT(*) FROM [base_monsanto].[dbo].[GLA_CUSTOMER] WHERE name = '" + name.ToUpper() + "' AND document = '" + doc + "' ";
            ...
            query = " INSERT INTO [base_monsanto].[dbo].[GLA_CUSTOMER] (name, document, sap, sap_filial, unidade, regional) ";
        ...
        public DataSet retCustomers()
        {
            ...
            query = " SELECT name, document, regional, unidade, agric  FROM [base_monsanto].[dbo].[GLA_CUSTOMER] WHERE DEL = '' ORDER BY ID DESC";
            dbAcess.execSql("select", query);
        ...
        public DataSet searcCustomers(String name, String document, String id, String gla)
        {
            ...
            query = " SELECT id, name, document, regional, unidade, sap, sap_filial FROM [base_monsanto].[dbo].[GLA_CUSTOMER] WHERE DEL is null ";
        ...
        public String changeCustomer(Int64 id, String name, String document, String delete, String sap, String sap_filial, String regional, String unidade)
        {
            String ret = "";
            DataSet dsRet = new DataSet();
            query = " SELECT COUNT(*) FROM [base_monsanto].[dbo].[GLA_CUSTOMER] WHERE id = '" + id + "' ";
            dbAcess.execSql("select", query);
            ...
            if (dsRet != null && dsRet.Tables.Count > 0)
            {
                ...
                query = " UPDATE [base_monsanto].[dbo].[GLA_CUSTOMER] SET name = '" + name.ToUpper() +"', document = '"+document+"', del = "+delete+" , sap = '" + sap + "', sap_filial = '" + sap_filial + "', regional = '" + regional + "', unidade = '" + unidade + "' ";
                query += " WHERE ID = "+id+" ";
        ...
        public string insertContract (string type, string id_client, ref string id_contract, string useradd)
        {
            ...
            query = " SELECT ISNULL(MAX(ID),0)+1 INFO from [base_monsanto].[dbo].[GLA_CONTRACT] ";

            dbAcess.execSql("select", query);

            id_contract = dbAcess.dsReturn.Tables[0].Rows[0]["INFO"].ToString();

            query = " INSERT INTO [base_monsanto].[dbo].[GLA_CONTRACT] (type_contract, id_client, id, useradd, lastupduser) " ;
        ...
        public DataSet selectContract (String id)
        {
            ...
            query = " SELECT * ";
            query += " FROM [base_monsanto].[dbo].[GLA_CONTRACT] ";
            query += " WHERE id = " + id + "";
        ...
        public String insertDocument (String id_contract, String id_client, String docname, String path)
        {
            String query = "";
            String ret = "";
            query = " INSERT INTO [base_monsanto].[dbo].[GLA_DOCUMENT] (id_contract, id_client, docname, path) ";
        ...
        public DataSet selectDocument(String id_contract)
        {
            ...
            query = " SELECT * FROM [base_monsanto].[dbo].[GLA_DOCUMENT] WHERE id_contract = '"+ id_contract + "' ";
        ...
        public String deleteDocByContract(String id_contract)
        {
            String query = "";
            String ret = "";
            query = " DELETE FROM [base_monsanto].[dbo].[GLA_DOCUMENT] ";
        ...
        public DataSet selectRTV()
        {
            ...
            query += " SELECT name FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE del is null AND ACTIVE = 1 AND TYPE = 3 ";
        ...
        public DataSet selectGR()
        {
            ...
            query = " SELECT '' name union all ";
            query += " SELECT name FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE del is null AND ACTIVE = 1 AND TYPE = 4 ";
        ...
        public void valDocCont(string id_contract, string docname)
        {
            ...
            query = " SELECT id_doc FROM [base_monsanto].[dbo].[GLA_CONTRACT] WHERE id = "+id_contract+" ";
            ...
            if (dsRet != null && dsRet.Tables.Count > 0)
            {
                ...
                {
                    query = " UPDATE [base_monsanto].[dbo].[GLA_CONTRACT] SET id_doc = '"+docname+"' WHERE id = "+id_contract+"";
        ...
        public bool changePass(string username, string newPass, string conPass)
        {
            ...
            try
            {
                query = " UPDATE [base_monsanto].[dbo].[GLA_REGISTER] set pass = '" + dbAcess.Encrypt(conPass) + "', changepass = 'S' ";
            ...
            string distrito, string regional, string cont1, string cont2, string endereco, string usergla)
        {
            String ret = "";
            DataSet dsRet = new DataSet();
            query = " SELECT COUNT(*) FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE login = '" + login + "' AND (del is null or del = '') ";
            dbAcess.execSql("select", query);
            ...
            query = " INSERT INTO [base_monsanto].[dbo].[GLA_REGISTER] (name, email, login, type, active, distrito, regional, contato1, contato2, endereco, usergla) ";
            ...
            string distrito, string regional, string cont1, string cont2, string endereco)
        {
            ...
            query = " SELECT login, name, email, case when active = 1 then 'ATIVO' else 'INATIVO' end status, regional FROM [base_monsanto].[dbo].[GLA_REGISTER] ";
        ...
        public DataSet selectDatUsers(string login, string type)
        {
            ...
            query = " SELECT * FROM [base_monsanto].[dbo].[GLA_REGISTER] ";
            query += " WHERE del is null AND TYPE = " + type + " ";
        ...
        public void deleteUser(string login)
        {
            ...
            query = " SELECT login FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE login = '" + login + "' ";
            ...
            if (dsRet != null && dsRet.Tables.Count > 0)
            {
                if (!String.IsNullOrEmpty(dsRet.Tables[0].Rows[0][0].ToString()))
                {
                    query = " UPDATE [base_monsanto].[dbo].[GLA_REGISTER] SET del = '*' WHERE login = '" + login + "'";
        ...
        public void deleteContract(string id_contract)
        {
            ...
            query = " DELETE FROM [base_monsanto].[dbo].[GLA_CONTRACT] WHERE id = '" + id_contract + "'";
            ...
            string distrito, string regional, string cont1, string cont2, string endereco)
        {
            String ret = "";
            DataSet dsRet = new DataSet();
            query = " SELECT COUNT(*) FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE login = '" + login + "' ";
            dbAcess.execSql("select", query);
            ...
            query = " UPDATE [base_monsanto].[dbo].[GLA_REGISTER] set name = '" + name.ToUpper() + "', ";
            query += " email = '" + email + "', ";
            query += " type =  '" + type + "', ";
            query += "active = '" + active + "', ";
        ...
        public string retUserMail (String name)
        {
            ...
            query = " SELECT distinct email FROM [base_monsanto].[dbo].[GLA_REGISTER] ";
        ...
        public string retNameCont(String id_contract)
        {
            ...
            query = " SELECT id_doc FROM [base_monsanto].[dbo].[GLA_CONTRACT] ";
        ...
        public string insertLog(string oldValue, string newValue, string id_contract, string field, string userName, string tableName)
        {
            ...
            query = " INSERT INTO [base_monsanto].[dbo].[GLA_AUDIT]( type, TableName, FieldName, OldValue, NewValue, UpdateDate, UserName, PK )";
        ...
        public DataSet selectLog(String reference, string doccli, string user)
        {
            ...
            query = @" SELECT FIELDNAME, OLDVALUE, NEWVALUE, UPDATEDATE, USERNAME, ID_DOC PK
                        FROM [base_monsanto].[dbo].[GLA_AUDIT] A
                        INNER JOIN [base_monsanto].[dbo].[GLA_CONTRACT] D
                        ON D.ID = REPLACE(REPLACE(A.PK, '<ID=', ''), '>', '')
                        INNER JOIN [base_monsanto].[dbo].[GLA_CUSTOMER] C
                        ON C.ID = D.ID_CLIENT";
        ...
        public DataSet selectPermission()
        {
            ...
            query = " SELECT * FROM [base_monsanto].[dbo].[GLA_PERMISSION] ORDER BY dt_register DESC";
        ...
        public string insertPermission(string id_user, string dtIni, string dtFim, string profile)
        {
            ...
            query = " INSERT INTO [base_monsanto].[dbo].[GLA_PERMISSION] (id_user, dt_perm_ini, dt_perm_end, profile, dt_register)";
        ...
        public string updatePermission(string id_user, string operation)
        {
            ...
            if (operation == "VALIDATE")
            {
                ...
                query += " FROM [base_monsanto].[dbo].[GLA_PERMISSION] WHERE id_user = '"+id_user+"' ";
            ...
            query = " UPDATE [base_monsanto].[dbo].[GLA_REGISTER] set TYPE = "+type+" where login = '" + id_user + "' ";
        ...
        public DataSet selectAllActiveUsers()
        {
            ...
            query = " SELECT name, login FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE del is null AND type = 2 ORDER BY 1 DESC";
        ...
        public String deletePermission(String id_user)
        {
            String query = "";
            String ret = "";
            query = " DELETE FROM [base_monsanto].[dbo].[GLA_PERMISSION] ";
        ...
        {
            query = " SELECT PASS FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE del is null AND login = '"+login+"' ";
        ...
        public DataSet selectAllCriteria(string type)
        {
            ...
            query = " SELECT * FROM [base_monsanto].[dbo].[GLA_CRITERIA] ";
        ...
        public string insertCriteria(string criteria, string type)
        {
            ...
            query = "INSERT INTO [base_monsanto].[dbo].[GLA_CRITERIA] (criteria, type) VALUES ('"+criteria+"','"+type+"') ";
        ...
        public string deleteCriteria(string id_criteria)
        {
            ...
            query = "DELETE FROM [base_monsanto].[dbo].[GLA_CRITERIA] WHERE id = " + id_criteria + " ";
        ...
        public DataSet selectAllRegion()
        {
            ...
            query = " SELECT * FROM [base_monsanto].[dbo].[GLA_REGIONS] ";
            query += "    ORDER BY 1 ASC";
        ...
        public string insertRegion(string region)
        {
            ...
            query = "INSERT INTO [base_monsanto].[dbo].[GLA_REGIONS] (region) VALUES ('" + region + "') ";
        ...
        public string deleteRegion(string id_region)
        {
            ...
            query = " SELECT COUNT(*) FROM [base_monsanto].[dbo].[GLA_REGISTER] where regional = (select distinct region from [base_monsanto].[dbo].[GLA_REGIONS] where id = '" + id_region + "') ";
            ...
            {
                query = "DELETE FROM [base_monsanto].[dbo].[GLA_REGIONS] WHERE id = " + id_region + " ";
        ...
        public DataSet selectAllSafra()
        {
            ...
            query = " SELECT * FROM [base_monsanto].[dbo].[GLA_SAFRA] ";
            query += "    ORDER BY 1 ASC";
        ...
        public string insertSafra(string safra)
        {
            ...
            query = "INSERT INTO [base_monsanto].[dbo].[GLA_SAFRA] (safra) VALUES ('" + safra + "') ";
        ...
        public string deleteSafra(string id_safra)
        {
            ...
            query = " SELECT COUNT(*) FROM [base_monsanto].[dbo].[GLA_CONTRACT] where safra = (select distinct safra from [base_monsanto].[dbo].[GLA_SAFRA] where id = '" + id_safra + "') ";
            ...
            {
                query = "DELETE FROM [base_monsanto].[dbo].[GLA_SAFRA] WHERE ID = " + id_safra + " ";
        ...
        public DataSet selectContAproved(string gr, string rtv, string safra, string regional, string document, string tpCont, string tpDoc)
        {
            ...
            query += " FROM [base_monsanto].[dbo].[GLA_CONTRACT] c ";
        ...
        public DataSet retDistByRTV (String rtv)
        {
            ...
            query = " SELECT distinct distrito FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE name = '"+rtv+"' and type = 3 and (del = '' or del is null) ";
        ...
        public DataSet retRegiByGR(String gr)
        {
            ...
            query = " SELECT distinct regional FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE name = '" + gr + "' and type = 4 ";
        ...
        public Boolean valueValidation (String value, int type)
        {
            ...
            query = " SELECT COUNT(*) FROM [base_monsanto].[dbo].[GLA_REGISTER] WHERE name = '" + value + "' and type = "+type+" ";
        ...
        public DataSet selectAllGeneral(string gla_cad_type, string gla_cad_value)
        {
            ...
            query = " SELECT CASE WHEN gla_cad_type = 'cy' THEN 'CY'" +
                    ...
                    " gla_cad_value, id_gla_cad_generic FROM [base_monsanto].[dbo].[GLA_CAD_GENERIC] WHERE id_gla_cad_generic > 0";
        ...
        public DataSet selectAllGlaCad(string gla_cad_type)
        {
            ...
            query += " SELECT gla_cad_value GLA_VAL FROM [base_monsanto].[dbo].[GLA_CAD_GENERIC] ";
            query += " WHERE gla_cad_type = '" + gla_cad_type + "' ";
            //query += "    ORDER BY 1 ASC";
        ...
        public string insertGlaCad(string gla_cad_type, string gla_cad_value)
        {
            ...
            query = "INSERT INTO [base_monsanto].[dbo].[GLA_CAD_GENERIC] (gla_cad_type,gla_cad_value) VALUES ('" + gla_cad_type + "','" + gla_cad_value + "') ";
        ...
        public string deleteGlaCad(string id_gla_cad_generic)
        {
            ...
            query = "DELETE FROM [base_monsanto].[dbo].[GLA_CAD_GENERIC] WHERE id_gla_cad_generic = " + id_gla_cad_generic + " ";
        ...
        public DataSet selectCustomerAndContract(string name, string document, string sap, string distrito, string unidade, string regional, string sap_filial)
        {
            ...
            query = @" SELECT DISTINCT ID, NAME, DOCUMENT, SAP, SAP_FILIAL FROM [BASE_MONSANTO].[DBO].[GLA_CUSTOMER] C 
                        WHERE DEL IS NULL ";

            if(!string.IsNullOrEmpty(distrito) || !string.IsNullOrEmpty(unidade) || !string.IsNullOrEmpty(regional))
            {
                query += @"  AND EXISTS( 
                        SELECT* FROM GLA_CONTRACT CON WHERE CON.ID_CLIENT = C.ID";
...
cus.sap Sap, cus.sap_filial SapFilial, dt_contract DataContrato, cy CY, cultura Cultura, distrito Marca, con.unidade Unidade, distrito Regional 
                            from GLA_CONTRACT con
                            inner join GLA_CUSTOMER cus ON cus.ID = con.id_client 
