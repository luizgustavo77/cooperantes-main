...
namespace apoio_monsanto.gla
{
    public partial class form_general : System.Web.UI.Page
    {
        ...
        {
            string delete = "<a href='/gla/general?del=" + Eval("id_gla_cad_generic") + "' class='btn btn-danger btn - xs fa fa-trash-o tooltips'  data-original-title='Excluir Cadastro'></a>&nbsp;";
            return delete;
        }
