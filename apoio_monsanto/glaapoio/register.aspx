<%@ Page Title="" Language="C#" MasterPageFile="~/newgla.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="apoio_monsanto.glaapoio.register" %>
            ...
            <div class="col-md-12 mb">
                <div class="form-panel">
                        ...
                        <div class="form-group">
                            <div class="row col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <asp:TextBox ID="txDc" class="form-control" runat="server" onkeypress="copydata()" placeholder="Digite o CPF ou CNPJ do Cliente"></asp:TextBox>
                                </div>
                                </div>
                             <div class="row col-sm-12">
                                <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <asp:ObjectDataSource ID="obCustomers" runat="server" SelectMethod="searcCustomers" TypeName="apoio_monsanto.newmom">
                            <SelectParameters>
