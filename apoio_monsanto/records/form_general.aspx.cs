...
namespace apoio_monsanto.records
{
    public partial class form_general : System.Web.UI.Page
    {
        ...
        {
            string delete = "<a href='/records/general?del=" + Eval("id_gla_cad_generic") + "' class='btn btn-danger btn - xs fa fa-trash-o tooltips'  data-original-title='Excluir Cadastro'></a>&nbsp;";
            return delete;
        }
