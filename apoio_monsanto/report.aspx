                            ...
                            <div class="form-group">
                                <div class="col-lg-3">
                                    ...
                                    <asp:DropDownList ID="ddTipoCont" runat="server" class="btn btn-default dropdown-toggle" data-toggle="dropdown" AutoPostBack="false" onclick="getDisabled();">
                                        ...
                                        <asp:ListItem Value="6">Groud Breakers</asp:ListItem>
                                    <asp:ListItem Value="7">Distribuidor Algodão</asp:ListItem>
                                    <asp:ListItem Value="8">Multiplicador Algodão</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
